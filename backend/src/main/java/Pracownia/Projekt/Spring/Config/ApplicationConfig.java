...
import Pracownia.Projekt.Spring.Services.UserService;
...
public class ApplicationConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authProvider.setUserDetailsService(userDetailsService()); // which user details service use in order to fetch information about user
